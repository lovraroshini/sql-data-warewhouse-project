...
====================================================
	Script Purpose:This script create a new database named 'DataWarwhouse' after checking if
	it already exists, it is dropped and recreated. Additionally, the script sets up three
